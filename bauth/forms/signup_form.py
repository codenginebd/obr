...
class SignupForm(forms.Form):
    ...
    last_name = forms.CharField(max_length=200, required=True, widget=forms.TextInput(
        attrs={"class": "signup_field"}))
    email = forms.EmailField(max_length=200, validators=[ validate_email ], required=True, widget=forms.TextInput(
        attrs={"class": "signup_field", "placeholder": "e.g someone@email.com"}))
    phone = forms.CharField(max_length=200, validators=[ validate_phone_number ], required=True, widget=forms.TextInput(
