...
ALTER TABLE book_rental_dev.book_rental_author MODIFY COLUMN name_bn VARCHAR(500)
CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;

ALTER TABLE book_rental_dev.book_rental_author MODIFY COLUMN description_bn VARCHAR(500)
CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;

//For Publisher table
ALTER TABLE book_rental_dev.book_rental_bookpublisher MODIFY COLUMN name_bn VARCHAR(500)
CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;

ALTER TABLE book_rental_dev.book_rental_bookpublisher MODIFY COLUMN description_bn VARCHAR(500)
CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;
