...
from promotion.models.ref_coupon_book import RefCouponBook
...
class RefCoupon(BaseEntity):
    ...
    gift_type = models.IntegerField(default=0) # 0 amount, 1 book, 2 free shipping
    gift_amount = models.DecimalField(max_digits=20, decimal_places=2)
    books = models.ManyToManyField(RefCouponBook)